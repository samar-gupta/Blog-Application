...
function Dashboard() {
    ...
    return (
        <Layout>
            <div className="py-10">
                <div
                    className="flex flex-wrap justify-start items-center lg:justify-center gap-5 lg:gap-10 px-4 lg:px-0 mb-8">
                    <div className="left">
                        <img
                    ...
                    <div className="right">
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">samargupta0710@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
